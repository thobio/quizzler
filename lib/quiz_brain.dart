...
class QuizBrain {
  ...
  void nextQuestion() {
    if (_indexPathQuestion < _questionBank.length - 1) {
      _indexPathQuestion++;
    }
  }
  ...
  void resetTheIndex() {
    _indexPathQuestion = 0;
  }

  String getQuestionText() {
    return _questionBank[_indexPathQuestion].questionText;
  }

  bool getQuestionAnswer() {
    return _questionBank[_indexPathQuestion].questionAnswer;
  }
}
